...
let p1Move = []; //track player 1
let p2Move = []; //track player 2
...
//TODO : CREATE A FUNCTION TO GET EACH PLAYER MOVEMENT
...
function handleNextRound() {
    ...
    // updates xScore | oScore  | tie Count
    //clears each player's move
}
